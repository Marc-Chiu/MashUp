...
<<<<<<< HEAD
            client = pm.MongoClient(f'mongodb+srv://mmc9967:{password}'
                                    + '@cluster0.sxibnal.mongodb.net/'
                                    + '?retryWrites=true&w=majority')
=======
            client = pm.MongoClient(f"mongodb+srv://mmc9967:{password}@cluster0.sxibnal.mongodb.net/?retryWrites=true&w=majority")
>>>>>>> 81cc45a (made changes from meeting)
